...
슬래시 커맨드(/인증, /리더보드, /스탯설정, /구단역할, /내정보, /인증해제, /하이브상태, /진행이벤트)는 최초 1회만 등록하면 된다:
...
8. `/진행이벤트` — 컴프야v26 공식 커뮤니티(cpbv-community.com2us.com)의 진행 중 이벤트 게시판을 실시간으로 조회 (인증 여부와 무관하게 누구나 사용 가능)
